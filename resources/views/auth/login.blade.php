            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <x-text-input id="email" class="form-input rounded-md shadow-sm mt-1 block w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                    ...
                    <div class="mb-3">
                        ...
                        <x-text-input id="password" class="form-input rounded-md shadow-sm mt-1 block w-full" type="password" name="password" required autocomplete="current-password" />
