...
<header class="text-center">
    <div class="container">
        <div class="texto-blanco" style="padding: 130px;"> <!-- Envuelve el contenido de texto en un cuadro blanco -->
            ...
            <br><br><br><br>
            <a class="login-btn"  href="{{ route('login') }}" class="login-btn">Login</a>
            <a class="register-btn" href="{{ route('register') }}" class="register-btn">Register</a>
        </div>
    </div>
</header>
